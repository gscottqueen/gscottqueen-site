    ...
    <div className="about-wrapper">
      ...
      <div>
        ...
        <p>
          ...
          Carolina at Wilmington. While in his studies at the university, Queen
          worked primarily in sculpture, painting, and digital media through the
          artist collective Thrive Studios and international art colony, No
          Boundaries. Executing and participating in dozens of exhibitions and
          interactive exhibits bringing music, film, and artistry into
          collaboration. It was here that Queen found success exploring live
          music and art performances with real-time digital projections. Several
          of his large-scale sculptures were featured in indie award winning
          films and awarded the Pedestrian Public Art Award.
        </p>
        <p>
          ...
          His experimentations utilize generative and cybernetic programming,
          machine learning, AI, brain network hardware, custom computers, and
          extended reality (AR, VR, Omniverse) for expressive purposes. In this
          age of computerization Queen believes we must explore the most
          creative approaches to problem solving. If we engage with technology
          collaboratively we can unlock the full potential of our societies and
          future generations.
        </p>
